...
abstract class CmsBasePanel implements PanelContract
{
    ...
    public function __construct(PanelPresenterContract $panelPresenterContract, PanelRouteService $panelRouteService)
    {
        $this->presenter = $panelPresenterContract->setPanel($this);
    ...
    */
    ...
    public function update(array $data): self
    {
        ...
        return $func::dispatchNow($data, $this);
    }
